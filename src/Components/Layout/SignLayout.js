...
const SignLayout = ({ children }) => {
  ...
  const isSkillPage = location.pathname.includes('new/skills')
  ...
  return (
    <div
      ...
      className={
        isSkillPage
          ? 'bg-[#FED821] flex w-full relative'
          : 'block lg:flex w-full h-[1143px] lg:h-[1024px] relative'
      }
      // className="bg-[#FED821] flex w-full relative"
    >
      <div
        className={
          'bg-[#FED821] w-full lg:w-[45%] xl:w-[48%] h-[508px] lg:h-full flex flex-col lg:flex-row justify-start lg:justify-center items-center m-auto sm:pt-[82px] lg:pt-0 pt-[82px]'
        }
      >
